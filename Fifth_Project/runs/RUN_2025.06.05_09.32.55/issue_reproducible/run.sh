...
export CURRENT_DEF='./tmp/cts/13-semi_cpu_top.resized.def';
export CURRENT_NETLIST='./tmp/cts/13-semi_cpu_top.resized.nl.v';
export CURRENT_ODB='./tmp/cts/13-semi_cpu_top.resized.odb';
export CURRENT_POWERED_NETLIST='./tmp/cts/13-semi_cpu_top.resized.pnl.v';
export DATA_WIRE_RC_LAYER='met2';
export DESIGN_NAME='semi_cpu_top';
...
export PACKAGED_SCRIPT_7='openlane/designs/Fifth_Project/semi_cpu_top.sdc';
export PACKAGED_SCRIPT_8='./tmp/14-semi_cpu_top.sdc';
export PACKAGED_SCRIPT_9='openlane/scripts/openroad/common/set_global_connections.tcl';
export PNR_SDC_FILE='openlane/designs/Fifth_Project/semi_cpu_top.sdc';
...
export SAVE_DEF='./tmp/14-semi_cpu_top.def';
export SAVE_NETLIST='./out.v';
export SAVE_ODB='./tmp/14-semi_cpu_top.odb';
export SAVE_POWERED_NETLIST='./tmp/14-semi_cpu_top.pnl.v';
export SAVE_SDC='./tmp/14-semi_cpu_top.sdc';
export SCRIPTS_DIR='openlane/scripts';
export SIGNOFF_SDC_FILE='openlane/designs/Fifth_Project/semi_cpu_top.sdc';
