...
set ::env(CURRENT_DEF) "./tmp/cts/13-semi_cpu_top.resized.def";
set ::env(CURRENT_NETLIST) "./tmp/cts/13-semi_cpu_top.resized.nl.v";
set ::env(CURRENT_ODB) "./tmp/cts/13-semi_cpu_top.resized.odb";
set ::env(CURRENT_POWERED_NETLIST) "./tmp/cts/13-semi_cpu_top.resized.pnl.v";
...
set ::env(PACKAGED_SCRIPT_7) "openlane/designs/Fifth_Project/semi_cpu_top.sdc";
set ::env(PACKAGED_SCRIPT_8) "./tmp/14-semi_cpu_top.sdc";
...
set ::env(SAVE_DEF) "./tmp/14-semi_cpu_top.def";
set ::env(SAVE_NETLIST) "./out.v";
set ::env(SAVE_ODB) "./tmp/14-semi_cpu_top.odb";
set ::env(SAVE_POWERED_NETLIST) "./tmp/14-semi_cpu_top.pnl.v";
set ::env(SAVE_SDC) "./tmp/14-semi_cpu_top.sdc";
