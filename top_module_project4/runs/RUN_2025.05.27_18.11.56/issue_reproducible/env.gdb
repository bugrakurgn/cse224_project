...
set env CURRENT_DEF ./tmp/cts/13-top_module_project4.resized.def
set env CURRENT_NETLIST ./tmp/cts/13-top_module_project4.resized.nl.v
set env CURRENT_ODB ./tmp/cts/13-top_module_project4.resized.odb
set env CURRENT_POWERED_NETLIST ./tmp/cts/13-top_module_project4.resized.pnl.v
...
set env PACKAGED_SCRIPT_8 ./tmp/14-top_module_project4.sdc
...
set env SAVE_DEF ./tmp/14-top_module_project4.def
set env SAVE_NETLIST ./out.v
set env SAVE_ODB ./tmp/14-top_module_project4.odb
set env SAVE_POWERED_NETLIST ./tmp/14-top_module_project4.pnl.v
set env SAVE_SDC ./tmp/14-top_module_project4.sdc
